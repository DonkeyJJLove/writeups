...
1. sama funkcja aktualizacji stanu $F_\theta$,
2. oraz zestaw reguł decyzyjnych opisany funkcją
   $$A_{t+1} = G(S_{t+1}),$$
...
* a protokół kontekstu po stronie bytu $Y$ jest **częściowo poznany**, jeśli z obserwowanych par $(M_t, A^{(Y)}_{t+1})$ potrafimy zbudować przybliżenia
  $$\hat{F}^{(Y)} \approx F^{(Y)}, \qquad \hat{G}^{(Y)} \approx G^{(Y)},$$
  które przewidują reakcje bytu $Y$ istotnie lepiej niż losowo / baseline.

W praktyce oznacza to coś bardzo prostego:

> jeśli na podstawie reakcji systemu bezpieczeństwa na nasze posty możemy z sensowną dokładnością przewidzieć, **kiedy** zablokuje konto, a **kiedy nie** – to znaczy, że **złamaliśmy fragment jego protokołu kontekstu**.
...
to w praktyce wykonuję **łamanie protokołu**:

* redukuję czarną skrzynkę do **funkcji decyzyjnej rozpisanej „na logikę”**,
* zdobywam **model mentalny** tego, na co system jest najbardziej wrażliwy.
...
$$
(\mathbf{v},\ \text{timestamp},\ \text{source_id}),
$$
...
URL:
[https://www.facebook.com/RE9OS0VZSkpMT1ZF/posts/pfbid0sLrnDqhfrXZCCrTMYM5GyUot17tRVN9ypYsGdHu74XBnpzYghdtHLa8kvViF8Fysl](https://www.facebook.com/RE9OS0VZSkpMT1ZF/posts/pfbid0sLrnDqhfrXZCCrTMYM5GyUot17tRVN9ypYsGdHu74XBnpzYghdtHLa8kvViF8Fysl)

**Wieremiejczyk, S. (2025).** „Facebook ML”.
Post na Facebooku, 27 XI 2025.
URL:
[https://www.facebook.com/RE9OS0VZSkpMT1ZF/posts/pfbid02fGGv4WBGw58ekdH1ukTxJHRR3VhH957g8KyyCUfbGyUHY76TTmvE2bQx4cYxiduRl](https://www.facebook.com/RE9OS0VZSkpMT1ZF/posts/pfbid02fGGv4WBGw58ekdH1ukTxJHRR3VhH957g8KyyCUfbGyUHY76TTmvE2bQx4cYxiduRl)
